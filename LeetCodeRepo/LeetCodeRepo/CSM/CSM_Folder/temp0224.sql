...
FROM vwUsageMonthly um -- bridge / servicebilling
INNER JOIN #SubscriptionList_II SL  --Subscritionsnapshotv2
  ON UM.AI_SubscriptionKey = SL.AI_SubscriptionKey
LEFT JOIN #BillingResourceGUID2Service_II sh --service hierarchy v2
